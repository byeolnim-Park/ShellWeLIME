...
public class Sell_Buy : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        talkbar.GetComponent<Text>().text = "어서오세요. 라임 상점입니다.";
    ...
    public void buy_ok()
    {
        ...
        {
            game_director.change_lime(count);
    ...
    public void sell_ok()
    {
        if (count < game_director.lime)
        {
            game_director.change_lime(-1 * count);
